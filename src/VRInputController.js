 ...
 *   Head lean (either controller absent):
...
export class VRInputController {
  ...
  constructor(renderer) {
    ...
    this.state = { steer: 0, throttle: 0, brake: 0, handbrake: false, leanAmount: 0 };
  ...
  _readXRControllers(session) {
    ...
    return { steer, throttle, brake, handbrake, steerActive, throttleActive, brakeActive, leanAmount };
  }
